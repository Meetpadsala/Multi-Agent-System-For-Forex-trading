...
def search_pairs(request):
    ...
    return render(request, 'search.html', {'pairs': filtered_pairs, 'query': query})
...
def admin_agents(request):
    ...
    return render(request, 'admin/admin_agents.html', context)
...
def admin_forex_data(request):
    ...
    return render(request, 'admin/admin_forex_data.html', context)
...
def admin_risk_analysis(request):
    ...
    return render(request, 'admin/admin_risk_analysis.html', context)
...
def admin_create_agent(request):
    ...
    agent_status_list = AgentStatus.objects.all().order_by('agent_name')
    return render(request, 'admin/admin_agents.html', {
        'form': form,
        'agent_status_list': agent_status_list,
        'mode': 'create'
    })
